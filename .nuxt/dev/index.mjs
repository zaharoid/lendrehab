...
import { renderToString } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/vue/index.mjs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/Zakhar/Documents/UNI/web_systems/lendrehab/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/Zakhar/Documents/UNI/web_systems/lendrehab","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/Zakhar/Documents/UNI/web_systems/lendrehab/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/Zakhar/Documents/UNI/web_systems/lendrehab/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/Zakhar/Documents/UNI/web_systems/lendrehab/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/Zakhar/Documents/UNI/web_systems/lendrehab/.data/kv"}));
...
const _GhztKQgOC5aygJXVYlWmR96GP1MMPcS7IzCxXpcgpsE = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/Zakhar/Documents/UNI/web_systems/lendrehab";
...
const _Mvhbrn6AGGH2cbd0B6epgSv1B1u1yGaelCm4lOfiPh4 = (nitroApp) => {
...
const _pWkXSvbFdIjm3p5kwtLBFM7MlzjWxswBisZvgIuDg = defineNitroPlugin((nitroApp) => {
  nitroApp.h3App.options.onError = (error, event) => {
    ...
    if (error instanceof HttpError) {
      ...
      return {
        error: error.message,
        details: (_a = error.details) != null ? _a : null
      };
    }
...
const plugins = [
  _GhztKQgOC5aygJXVYlWmR96GP1MMPcS7IzCxXpcgpsE,
_Mvhbrn6AGGH2cbd0B6epgSv1B1u1yGaelCm4lOfiPh4,
...
const _EOWzEr = eventHandler((event) => {
...
const _0pfP50 = defineEventHandler((event) => {
});
...
const getServerEntry = () => import('file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/Zakhar/Documents/UNI/web_systems/lendrehab/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_oEOxOo = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_wCQ3kK = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_0_sJpN = () => Promise.resolve().then(function () { return _id__get$3; });
const _lazy_itKUQT = () => Promise.resolve().then(function () { return _id__patch$1; });
const _lazy_3n7PDY = () => Promise.resolve().then(function () { return index_get$3; });
const _lazy_C3pkeY = () => Promise.resolve().then(function () { return index_post$3; });
const _lazy_i7dHc4 = () => Promise.resolve().then(function () { return openapi_get$1; });
const _lazy_b3oh02 = () => Promise.resolve().then(function () { return _id__get$1; });
...
const handlers = [
  { route: '', handler: _EOWzEr, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _0pfP50, lazy: false, middleware: true, method: undefined },
  { route: '/api/auth/login', handler: _lazy_oEOxOo, lazy: true, middleware: false, method: "post" },
  { route: '/api/devices/:id', handler: _lazy_wCQ3kK, lazy: true, middleware: false, method: "delete" },
  { route: '/api/devices/:id', handler: _lazy_0_sJpN, lazy: true, middleware: false, method: "get" },
  { route: '/api/devices/:id', handler: _lazy_itKUQT, lazy: true, middleware: false, method: "patch" },
  { route: '/api/devices', handler: _lazy_3n7PDY, lazy: true, middleware: false, method: "get" },
  { route: '/api/devices', handler: _lazy_C3pkeY, lazy: true, middleware: false, method: "post" },
  { route: '/api/openapi', handler: _lazy_i7dHc4, lazy: true, middleware: false, method: "get" },
  { route: '/api/reservations/:id', handler: _lazy_b3oh02, lazy: true, middleware: false, method: "get" },
